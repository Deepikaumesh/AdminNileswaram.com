...
class _NewAdd_CatagoryState extends State<NewAdd_Catagory> {
  ...
  Widget _buildcatName() {
    return Container(
      padding: EdgeInsets.symmetric(horizontal: 8.0, vertical: 4.0),
      child: TextField(
        controller: catname,
        decoration: InputDecoration(labelText: "Enter Catagory",
  ...
  Widget _buildName() {
    return Container(
      ...
      child: TextField(
        controller: name,
        decoration: InputDecoration(labelText: "Enter shop name",prefix: Text("(Add Catagory name \nbefore shop name)",style: TextStyle(fontSize: 12),),),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("New Catagory Registration",style: GoogleFonts.prompt(color: Colors.red.shade900),),backgroundColor: Colors.white,
