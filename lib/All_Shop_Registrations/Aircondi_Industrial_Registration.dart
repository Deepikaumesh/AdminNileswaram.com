...
class Aircondi_Industrial_RegPage extends StatefulWidget {
  @override
  _Aircondi_Industrial_RegPageState createState() => _Aircondi_Industrial_RegPageState();
}

class _Aircondi_Industrial_RegPageState extends State<Aircondi_Industrial_RegPage> {
  ...
  String serverUrl = "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Registration/A_REg/aircondi_indus.php";

  @override
  void initState() {
    name = TextEditingController(text: '(aircondition)');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Aircondition Industrial",style: GoogleFonts.prompt(color: Colors.red.shade900),),backgroundColor: Colors.white,
