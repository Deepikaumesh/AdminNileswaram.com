...
class Agriseeds_RegPage extends StatefulWidget {
  @override
  _Agriseeds_RegPageState createState() => _Agriseeds_RegPageState();
}

class _Agriseeds_RegPageState extends State<Agriseeds_RegPage> {
  ...
  String serverUrl = "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Registration/A_REg/agriseeds.php";

  @override
  void initState() {
    name = TextEditingController(text: '(agriculture)');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Agriculture Seeds",style: GoogleFonts.prompt(color: Colors.red.shade900),),backgroundColor: Colors.white,
