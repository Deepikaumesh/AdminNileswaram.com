...
class Accountant_RegPage extends StatefulWidget {
  @override
  _Accountant_RegPageState createState() => _Accountant_RegPageState();
}

class _Accountant_RegPageState extends State<Accountant_RegPage> {
  ...
  String serverUrl = "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Registration/A_REg/Accountant.php";

  @override
  void initState() {
    name = TextEditingController(text: '(accountant)');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Accountant Registration",style: GoogleFonts.prompt(color: Colors.red.shade900),),backgroundColor: Colors.white,
