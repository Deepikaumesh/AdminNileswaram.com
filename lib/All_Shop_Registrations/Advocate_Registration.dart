...
class Advocate_RegPage extends StatefulWidget {
  @override
  _Advocate_RegPageState createState() => _Advocate_RegPageState();
}

class _Advocate_RegPageState extends State<Advocate_RegPage> {
  ...
  String serverUrl = "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Registration/A_REg/advocate.php";

  @override
  void initState() {
    name = TextEditingController(text: '(advocate)');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Advocate Registration",style: GoogleFonts.prompt(color: Colors.red.shade900),),backgroundColor: Colors.white,
