...
class Aircondi_Domestict_RegPage extends StatefulWidget {
  @override
  _Aircondi_Domestict_RegPageState createState() => _Aircondi_Domestict_RegPageState();
}

class _Aircondi_Domestict_RegPageState extends State<Aircondi_Domestict_RegPage> {
  ...
  String serverUrl = "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Registration/A_REg/air_condi.php";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Aircondition Domestic",style: GoogleFonts.prompt(color: Colors.red.shade900),),backgroundColor: Colors.white,
