...
class Advertising_RegPage extends StatefulWidget {
  @override
  _Advertising_RegPageState createState() => _Advertising_RegPageState();
}

class _Advertising_RegPageState extends State<Advertising_RegPage> {
  ...
  String serverUrl = "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Registration/A_REg/advertising.php";

  @override
  void initState() {
    name = TextEditingController(text: '(advertising)');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Advertising Registration",style: GoogleFonts.prompt(color: Colors.red.shade900),),backgroundColor: Colors.white,
