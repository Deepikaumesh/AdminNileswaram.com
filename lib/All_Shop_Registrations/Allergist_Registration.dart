...
class Allergist_RegPage extends StatefulWidget {
  @override
  _Allergist_RegPageState createState() => _Allergist_RegPageState();
}

class _Allergist_RegPageState extends State<Allergist_RegPage> {
  ...
  String serverUrl = "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Registration/A_REg/allergist.php";

  @override
  void initState() {
    name = TextEditingController(text: '(allergist)');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Allergist",style: GoogleFonts.prompt(color: Colors.red.shade900),),backgroundColor: Colors.white,
