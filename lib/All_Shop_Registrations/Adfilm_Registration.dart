...
class Adfilm_RegPage extends StatefulWidget {
  @override
  _Adfilm_RegPageState createState() => _Adfilm_RegPageState();
}

class _Adfilm_RegPageState extends State<Adfilm_RegPage> {
  ...
  String serverUrl = "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Registration/A_REg/adfilm.php";

  @override
  void initState() {
    name = TextEditingController(text: '(adfilm)');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Adfilm Registration",style: GoogleFonts.prompt(color: Colors.red.shade900),),backgroundColor: Colors.white,
