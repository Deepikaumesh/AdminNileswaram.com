...
class Restaurant_Reg_Page extends StatefulWidget {
  @override
  _Restaurant_Reg_PageState createState() => _Restaurant_Reg_PageState();
}

class _Restaurant_Reg_PageState extends State<Restaurant_Reg_Page> {
  ...
  String serverUrl = "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Registration/Restaurant_Registration.php";

  @override
  void initState() {
    name = TextEditingController(text: 'Restaurant-');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Restaurant Registration",style: GoogleFonts.prompt(color: Colors.red.shade900),),backgroundColor: Colors.white,
