...
class Agri_RegPage extends StatefulWidget {
  @override
  _Agri_RegPageState createState() => _Agri_RegPageState();
}

class _Agri_RegPageState extends State<Agri_RegPage> {
  ...
  String serverUrl = "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Registration/A_REg/agri.php";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Agriculture Machinery Registration",style: GoogleFonts.prompt(color: Colors.red.shade900),),backgroundColor: Colors.white,
