...
class News_Delete_Detail extends StatefulWidget {
  List list;
  int index;
  News_Delete_Detail({required this.index,required this.list});
  @override
  _News_Delete_DetailState createState() => new _News_Delete_DetailState();
}

class _News_Delete_DetailState extends State<News_Delete_Detail> {
