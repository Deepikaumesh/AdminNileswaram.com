...
class Representatve_Detail extends StatefulWidget {
  List list;
  int index;
  Representatve_Detail({required this.index,required this.list});
  @override
  _Representatve_DetailState createState() => new _Representatve_DetailState();
}

class _Representatve_DetailState extends State<Representatve_Detail> {

  void deleteData(){
    //var url="http://10.0.2.2/my_store/deleteData.php";
    var url= "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Delete/Delete_Representatives.php";
