...
class Tourist_Place_Delete_Detail extends StatefulWidget {
  List list;
  int index;
  Tourist_Place_Delete_Detail({required this.index,required this.list});
  @override
  _Tourist_Place_Delete_DetailState createState() => new _Tourist_Place_Delete_DetailState();
}

class _Tourist_Place_Delete_DetailState extends State<Tourist_Place_Delete_Detail> {

  void deleteData(){
    //var url="http://10.0.2.2/my_store/deleteData.php";
    var url= "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Delete/Delete_Tourist_Place.php";
