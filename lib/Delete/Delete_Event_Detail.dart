...
class Event_Delete_Detail extends StatefulWidget {
  List list;
  int index;
  Event_Delete_Detail({required this.index,required this.list});
  @override
  _Event_Delete_DetailState createState() => new _Event_Delete_DetailState();
}

class _Event_Delete_DetailState extends State<Event_Delete_Detail> {

  void deleteData(){
    //var url="http://10.0.2.2/my_store/deleteData.php";
    var url= "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Delete/Event_Delete.php";
