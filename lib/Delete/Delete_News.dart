...
class Delete_News extends StatefulWidget {
  @override
  _Delete_NewsState createState() => new _Delete_NewsState();
}

class _Delete_NewsState extends State<Delete_News> {
          ...
          child: new GestureDetector(
            onTap: ()=>Navigator.of(context).push(
                new MaterialPageRoute(
                    builder: (BuildContext context)=> new News_Delete_Detail(list:list , index: i,)
                )
            ),
            child: new Card(
