...
class Organisation_Delete_Detail extends StatefulWidget {
  List list;
  int index;
  Organisation_Delete_Detail({required this.index,required this.list});
  @override
  _Organisation_Delete_DetailState createState() => new _Organisation_Delete_DetailState();
}

class _Organisation_Delete_DetailState extends State<Organisation_Delete_Detail> {

  void deleteData(){
    //var url="http://10.0.2.2/my_store/deleteData.php";
    var url= "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Delete/Delete_Organisation.php";
