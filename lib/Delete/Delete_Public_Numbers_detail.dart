...
class Delete_Public_Number_Detail extends StatefulWidget {
  List list;
  int index;
  Delete_Public_Number_Detail({required this.index,required this.list});
  @override
  _Delete_Public_Number_DetailState createState() => new _Delete_Public_Number_DetailState();
}

class _Delete_Public_Number_DetailState extends State<Delete_Public_Number_Detail> {

  void deleteData(){
    //var url="http://10.0.2.2/my_store/deleteData.php";
    var url= "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Delete/Delete_Public_Numbers.php";
