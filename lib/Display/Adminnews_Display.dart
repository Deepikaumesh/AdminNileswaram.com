...
class Admin_News_Display extends StatefulWidget {
  @override
  _Admin_News_DisplayState createState() => _Admin_News_DisplayState();
}

class _Admin_News_DisplayState extends State<Admin_News_Display> {
